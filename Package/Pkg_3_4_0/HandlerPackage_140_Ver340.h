#ifndef HANDLERPACKAGE_140_VER340_H
#define HANDLERPACKAGE_140_VER340_H
...
namespace package {
class HandlerPackage_140_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_140_Ver340(QObject *parent = nullptr);
