...
HandlerPackage_0_Ver340::HandlerPackage_0_Ver340(QObject *parent)
...
bool HandlerPackage_0_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 0 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_nidVBCMKVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_0_Ver340::saveData );
...
bool HandlerPackage_0_Ver340::saveData()
{
    QString data;
...
void HandlerPackage_0_Ver340::deleteView()
{
...
void HandlerPackage_0_Ver340::loadPkg()
{
