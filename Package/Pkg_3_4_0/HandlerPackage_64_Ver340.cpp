...
HandlerPackage_64_Ver340::HandlerPackage_64_Ver340(QObject *parent)
...
bool HandlerPackage_64_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 64 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_64_Ver340::saveData );
...
void HandlerPackage_64_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_64_Ver340::saveData()
{
    QString data;
...
void HandlerPackage_64_Ver340::deleteView()
{
...
void HandlerPackage_64_Ver340::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
