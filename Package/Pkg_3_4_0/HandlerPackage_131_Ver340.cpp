...
HandlerPackage_131_Ver340::HandlerPackage_131_Ver340(QObject *parent)
...
bool HandlerPackage_131_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 131 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_131_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(129,129);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_131_Ver340::saveData );

        m_qScaleVar = new package::GraphicVariablePkg;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_131_Ver340::saveData );

        m_dRbctrVar = new package::GraphicVariablePkg;
        m_dRbctrVar->set_D_RBCTR();
        m_VariableVect.push_back(m_dRbctrVar);
        connect (m_dRbctrVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_131_Ver340::saveData );

        m_nidCVar = new package::GraphicVariablePkg;
        m_nidCVar->set_NID_C();
        m_VariableVect.push_back(m_nidCVar);
        connect (m_nidCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_131_Ver340::saveData );

        m_nidRbcVar = new package::GraphicVariablePkg;
        m_nidRbcVar->set_NID_RBC();
        m_VariableVect.push_back(m_nidRbcVar);
        connect (m_nidRbcVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_131_Ver340::saveData );

        m_nidRadioVar = new package::GraphicVariablePkg;
        m_nidRadioVar->set_NID_RADIO();
        m_VariableVect.push_back(m_nidRadioVar);
        connect (m_nidRadioVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_131_Ver340::saveData );
        ...
        connect (m_qSleepsessionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_131_Ver340::saveData );
...
void HandlerPackage_131_Ver340::loadPkg()
{
...
void HandlerPackage_131_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_131_Ver340::saveData()
{
...
void HandlerPackage_131_Ver340::deleteView()
{
