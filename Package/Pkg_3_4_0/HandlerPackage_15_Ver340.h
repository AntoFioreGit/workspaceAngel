#ifndef HANDLERPACKAGE_15_VER340_H
#define HANDLERPACKAGE_15_VER340_H
...
namespace package {
class HandlerPackage_15_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_15_Ver340(QObject *parent = nullptr);
...
private:
    ...
    package::GraphicVariablePkg *m_vLoaVar;
    package::GraphicVariablePkg *m_tLoaVar;
...
#endif // HANDLERPACKAGE_15_VER340_H
