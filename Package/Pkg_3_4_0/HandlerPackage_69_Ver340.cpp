...
HandlerPackage_69_Ver340::HandlerPackage_69_Ver340(QObject *parent)
...
bool HandlerPackage_69_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 69 - " + QString(BASELINE_3_4_0));
    ...
    connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
    connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
    connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
    connect (m_ScaleVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_69_Ver340::handleChangeScaleVariable_SL );
    connect (m_ScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
    connect (m_qTrackInitVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_69_Ver340::handleChangeQ_TrackInitVariable_SL );
    connect (m_qTrackInitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
    connect (m_dTrackCondVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
    connect (m_dTrackCondVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );

    connect (m_lTrackCondVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
    connect (m_mPlatformVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
    connect (m_qPlatformVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );

    connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::handleChangeIteration_SL );
    connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
    ...
    for (int i = positionIterateVar ;i < size ;i++) {
        ...
        if (nullptr != variable){
            connect (variable,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_69_Ver340::saveData );
        }
...
void HandlerPackage_69_Ver340::loadPkg()
{
...
void HandlerPackage_69_Ver340::handleChangeIteration_SL()
{
...
void HandlerPackage_69_Ver340::handleChangeScaleVariable_SL(QString nameVariable)
{
...
void HandlerPackage_69_Ver340::handleChangeQ_TrackInitVariable_SL(QString nameVariable)
{
    package::GraphicVariablePkg * variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    if (nullptr != variable){
...
void HandlerPackage_69_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_69_Ver340::saveData()
{
...
void HandlerPackage_69_Ver340::deleteView()
{
