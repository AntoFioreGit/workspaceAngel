...
HandlerPackage_51_Ver340::HandlerPackage_51_Ver340(QObject *parent)
...
bool HandlerPackage_51_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 51 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(41);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );

        m_qTrackinitVar = new package::GraphicVariablePkg;
        m_qTrackinitVar->set_Q_TRACKINIT();
        m_VariableVect.push_back(m_qTrackinitVar);
        connect (m_qTrackinitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::show_qTrackinit_SL );
        connect (m_qTrackinitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );

        {
            ...
            connect (m_dTrackinitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
            ...
            connect (m_dAxleloadVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
            ...
            connect (m_lAxleloadVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
            ...
            connect (m_qFrontVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
            ...
            connect (m_nIter_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::handleChangeIteration_n_SL );
            connect (m_nIter_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
            ...
            for (int n = 0; n < maxValueVariableIter_n ; n++)
            {
                ...
                connect (m_mAxleloadcat_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
                ...
                connect (m_vAxleload_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
            }
            ...
            connect (m_nIter_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::handleChangeIteration_k_SL );
            connect (m_nIter_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
            ...
            for (int k = 0;k < maxValueVariableIter_k ;k++)
            {
                ...
                connect (m_dAxleload_k_Var,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_51_Ver340::handleIterateVariable_SL );
                connect (m_dAxleload_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
                ...
                connect (m_lAxleload_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
                ...
                connect (m_nIter_k_m_Var,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_51_Ver340::handleChangeIteration_k_m_SL );
                connect (m_nIter_k_m_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
                ...
                for (int m = 0;m < maxValueVariableIter_k_m ;m++)
                {
                    ...
                    connect (m_mAxleloadCat_k_m_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
                    ...
                    connect (m_vAxleload_k_m_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_51_Ver340::saveData );
                }
            }
        }
...
void HandlerPackage_51_Ver340::loadPkg()
{
...
void HandlerPackage_51_Ver340::show_qTrackinit_SL()
{
...
void HandlerPackage_51_Ver340::handleChangeIteration_n_SL()
{
...
void HandlerPackage_51_Ver340::handleChangeIteration_k_SL()
{
...
void HandlerPackage_51_Ver340::handleChangeIteration_k_m_SL(QString nameVariable)
{
...
void HandlerPackage_51_Ver340::handleIterateVariable_SL(QString nameVariable)
{
    package::GraphicVariablePkg * p_variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    qDebug () << "nameVariable="<<nameVariable << "  Valore = "<< p_variable->valueOfVariable();
...
void HandlerPackage_51_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_51_Ver340::saveData()
{
...
void HandlerPackage_51_Ver340::deleteView()
{
