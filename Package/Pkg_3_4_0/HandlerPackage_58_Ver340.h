#ifndef HANDLERPACKAGE_58_VER340_H
#define HANDLERPACKAGE_58_VER340_H
...
namespace package {
class HandlerPackage_58_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_58_Ver340(QObject *parent = nullptr);
