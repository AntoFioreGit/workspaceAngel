#ifndef HANDLERPACKAGE_132_VER340_H
#define HANDLERPACKAGE_132_VER340_H
...
namespace package {
class HandlerPackage_132_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_132_Ver340(QObject *parent = nullptr);
...
private:
    ...
    package::GraphicVariablePkg *m_qAspectVar;
private:
    void showVariable();
