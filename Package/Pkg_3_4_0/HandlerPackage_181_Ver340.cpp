...
HandlerPackage_181_Ver340::HandlerPackage_181_Ver340(QObject *parent)
...
bool HandlerPackage_181_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 181 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_181_Ver340::saveData );

        m_lenPkgVar = new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(49, 49);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_181_Ver340::saveData );
...
void HandlerPackage_181_Ver340::loadPkg()
{
...
void HandlerPackage_181_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_181_Ver340::saveData()
{
...
void HandlerPackage_181_Ver340::deleteView()
{
