...
HandlerPackage_13_Ver340::HandlerPackage_13_Ver340(QObject *parent)
...
bool HandlerPackage_13_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 13 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(72, 1462);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );
        ...
        connect (m_qNewcountry_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::show_NIDc_1_SL );
        connect (m_qNewcountry_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );

        {
            ...
            connect (m_nidC_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );
        }

        m_nidBG_1_Var = new package::GraphicVariablePkg;
        m_nidBG_1_Var->set_NID_BG();
        m_VariableVect.push_back(m_nidBG_1_Var);
        connect (m_nidBG_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );
        ...
        connect (m_qNewcountry_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::show_NIDc_2_SL );
        connect (m_qNewcountry_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );

        {
            ...
            connect (m_nidC_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );
        }

        m_nidBG_2_Var = new package::GraphicVariablePkg;
        m_nidBG_2_Var->set_NID_BG();
        m_VariableVect.push_back(m_nidBG_2_Var);
        connect (m_nidBG_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );

        m_dSRVar = new package::GraphicVariablePkg;
        m_dSRVar->set_D_SR();
        m_VariableVect.push_back(m_dSRVar);
        connect (m_dSRVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );

        m_nIterVar =  new package::GraphicVariablePkg ;
        m_nIterVar->set_N_ITER();
        m_VariableVect.push_back(m_nIterVar);
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );
        ...
        for (int i = 0;i < maxValueVariableIter ;i++)
        {
            ...
            connect (m_qNewcountry_k_Var,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_13_Ver340::handleIterateVariable_SL );
            connect (m_qNewcountry_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );

            {
                ...
                connect (m_nidC_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );
            }
            ...
            connect (m_nidBG_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );
            ...
            connect (m_dSRV_k_ar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_13_Ver340::saveData );
        }
...
void HandlerPackage_13_Ver340::loadPkg()
{
...
void HandlerPackage_13_Ver340::show_NIDc_1_SL()
{
...
void HandlerPackage_13_Ver340::show_NIDc_2_SL()
{
...
void HandlerPackage_13_Ver340::handleChangeIteration_SL()
{
...
void HandlerPackage_13_Ver340::handleIterateVariable_SL(QString nameVariable)
{
...
void HandlerPackage_13_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_13_Ver340::saveData()
{
...
void HandlerPackage_13_Ver340::deleteView()
{
