#ifndef HANDLERPACKAGE_66_VER340_H
#define HANDLERPACKAGE_66_VER340_H
...
namespace package {
class HandlerPackage_66_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_66_Ver340(QObject *parent = nullptr);
