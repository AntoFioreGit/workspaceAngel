#ifndef HANDLERPACKAGE_254_VER340_H
#define HANDLERPACKAGE_254_VER340_H
...
namespace package {
class HandlerPackage_254_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_254_Ver340(QObject *parent = nullptr);
