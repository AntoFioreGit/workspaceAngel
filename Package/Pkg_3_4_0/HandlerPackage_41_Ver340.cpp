...
HandlerPackage_41_Ver340::HandlerPackage_41_Ver340(QObject *parent)
...
bool HandlerPackage_41_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 41 - " + QString(BASELINE_3_4_0));
    ...
    connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );
    connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );
    connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );
    connect (m_ScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );
    connect (m_dLevelTrVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );

    connect (m_mLevelTrVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_41_Ver340::handleChangeM_LevelTrVariable_SL );
    connect (m_mLevelTrVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );

    connect (m_nidNtcVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );

    connect (m_lAckLevelTrVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );


    connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::handleChangeIteration_SL );
    connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );
    ...
    for (int i = positionIterateVar ;i < size ;i++) {
        ...
        if (nullptr != variable){
            connect (variable,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_41_Ver340::saveData );
            if (variable->internalName().contains("M_LEVELTR_")){
                connect (variable,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_41_Ver340::handleChangeM_LevelTrIterVariable_SL );
            }
        }
...
void HandlerPackage_41_Ver340::handleChangeM_LevelTrIterVariable_SL(QString nameVariable)
{
...
void HandlerPackage_41_Ver340::handleChangeIteration_SL()
{
...
void HandlerPackage_41_Ver340::handleChangeQ_NewCountry_IterVariable_SL(QString nameVariable)
{
    package::GraphicVariablePkg * variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    if (nullptr != variable){
        QStringList parseNameVar = nameVariable.split("_");
...
void HandlerPackage_41_Ver340::handleChangeM_LevelTrVariable_SL()
{
...
void HandlerPackage_41_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_41_Ver340::saveData()
{
    QString data;
...
void HandlerPackage_41_Ver340::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
...
void HandlerPackage_41_Ver340::deleteView()
{
