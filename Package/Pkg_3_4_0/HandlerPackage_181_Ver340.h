#ifndef HANDLERPACKAGE_181_VER340_H
#define HANDLERPACKAGE_181_VER340_H
...
namespace package {
class HandlerPackage_181_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_181_Ver340(QObject *parent = nullptr);
