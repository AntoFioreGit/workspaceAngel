...
HandlerPackage_180_Ver340::HandlerPackage_180_Ver340(QObject *parent)
...
bool HandlerPackage_180_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 180 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_180_Ver340::saveData );

        m_lenPkgVar = new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(24, 32);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_180_Ver340::saveData );
        ...
        connect (m_qLssmaVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_180_Ver340::show_qLssma_SL );
        connect (m_qLssmaVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_180_Ver340::saveData );

        {
            ...
            connect (m_tLssmaVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_180_Ver340::saveData );
        }
...
void HandlerPackage_180_Ver340::show_qLssma_SL()
{
...
void HandlerPackage_180_Ver340::loadPkg()
{
...
void HandlerPackage_180_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_180_Ver340::saveData()
{
...
void HandlerPackage_180_Ver340::deleteView()
{
