...
HandlerPackage_66_Ver340::HandlerPackage_66_Ver340(QObject *parent)
...
bool HandlerPackage_66_Ver340::creteView()
{

    qDebug () << "HandlerPackage_66_Ver340::creteView();";
    bool ret = false;
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 66 - " + QString(BASELINE_3_4_0));
        ...
        showVariable();
        connect (m_nidTsr,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_66_Ver340::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_66_Ver340::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_66_Ver340::saveData );
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_66_Ver340::saveData );
        ret=true;
    }
...
void HandlerPackage_66_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_66_Ver340::saveData()
{
    QString data;
...
void HandlerPackage_66_Ver340::deleteView()
{
...
void HandlerPackage_66_Ver340::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
