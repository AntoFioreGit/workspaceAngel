#ifndef HANDLERPACKAGE_88_VER340_H
#define HANDLERPACKAGE_88_VER340_H
...
namespace package {
class HandlerPackage_88_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_88_Ver340(QObject *parent = nullptr);
