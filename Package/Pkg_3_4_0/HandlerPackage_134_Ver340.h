#ifndef HANDLERPACKAGE_134_VER340_H
#define HANDLERPACKAGE_134_VER340_H
...
namespace package {
class HandlerPackage_134_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_134_Ver340(QObject *parent = nullptr);
