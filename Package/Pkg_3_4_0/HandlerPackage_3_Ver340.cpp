...
HandlerPackage_3_Ver340::HandlerPackage_3_Ver340(QObject *parent)
...
bool HandlerPackage_3_Ver340::creteView()
{
    QString nameItem;
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 3 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_lenPkgVar = new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(100);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_dValidnvVar = new package::GraphicVariablePkg ;
        m_dValidnvVar->set_D_VALIDNV();
        m_VariableVect.push_back(m_dValidnvVar);
        connect (m_dValidnvVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_nidCVar = new package::GraphicVariablePkg ;
        m_nidCVar->set_NID_C();
        m_VariableVect.push_back(m_nidCVar);
        connect (m_nidCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_nIter_j_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::handleChangeIteration_nIter_j_SL );
        connect (m_nIter_j_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        for (int j = 0; j < numOfIteration; j++)
        {
            ...
            connect (m_nidC_j_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        }

        m_vNvshuntVar = new package::GraphicVariablePkg ;
        m_vNvshuntVar->set_V_NVSHUNT();
        m_VariableVect.push_back(m_vNvshuntVar);
        connect (m_vNvshuntVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_vNvstffVar = new package::GraphicVariablePkg ;
        m_vNvstffVar->set_V_NVSTFF();
        m_VariableVect.push_back(m_vNvstffVar);
        connect (m_vNvstffVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_vNvonsightVar = new package::GraphicVariablePkg ;
        m_vNvonsightVar->set_V_NVONSIGHT();
        m_VariableVect.push_back(m_vNvonsightVar);
        connect (m_vNvonsightVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_vNvlimsupervVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_vNvunfitVar = new package::GraphicVariablePkg ;
        m_vNvunfitVar->set_V_NVUNFIT();
        m_VariableVect.push_back(m_vNvunfitVar);
        connect (m_vNvunfitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_vNvrelVar = new package::GraphicVariablePkg ;
        m_vNvrelVar->set_V_NVREL();
        m_VariableVect.push_back(m_vNvrelVar);
        connect (m_vNvrelVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_vNvRollVar = new package::GraphicVariablePkg ;
        m_vNvRollVar->set_D_NVROLL();
        m_VariableVect.push_back(m_vNvRollVar);
        connect (m_vNvRollVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_qNvsbtsmpermVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_qNvemrrlsVar = new package::GraphicVariablePkg ;
        m_qNvemrrlsVar->set_Q_NVEMRRLS();
        m_VariableVect.push_back(m_qNvemrrlsVar);
        connect (m_qNvemrrlsVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_qNvguipermVar = new package::GraphicVariablePkg ;
        m_qNvguipermVar->set_Q_NVGUIPERM();
        m_VariableVect.push_back(m_qNvguipermVar);
        connect (m_qNvguipermVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_qNvsbfbpermVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_qNvnhsmicpermVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_vNvallowovtrpVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_qNvdriverAdhesVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_aNvmaxredadh1Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_aNvmaxredadh2Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
        ...
        connect (m_aNvmaxredadh3Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );


        m_qNvloaccVar = new package::GraphicVariablePkg ;
        m_qNvloaccVar->set_Q_NVLOCACC();
        m_VariableVect.push_back(m_qNvloaccVar);
        connect (m_qNvloaccVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_mNvavadhVar = new package::GraphicVariablePkg ;
        m_mNvavadhVar->set_M_NVAVADH();
        m_VariableVect.push_back(m_mNvavadhVar);
        connect (m_mNvavadhVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_mNvebclVar = new package::GraphicVariablePkg ;
        m_mNvebclVar->set_M_NVEBCL();
        m_VariableVect.push_back(m_mNvebclVar);
        connect (m_mNvebclVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        m_qNvkintVar = new package::GraphicVariablePkg ;
        m_qNvkintVar->set_Q_NVKINT();
        m_VariableVect.push_back(m_qNvkintVar);
        connect (m_qNvkintVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::show_qNvkint_SL );
        connect (m_qNvkintVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

        {
            ...
            connect (m_qNvkvintsetVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_3_Ver340::show_aNVP_SL );
            connect (m_qNvkvintsetVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

            {
                ...
                connect (m_aNvp12Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                ...
                connect (m_aNvp23Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            }
            ...
            connect (m_vNvkvintVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            ...
            connect (m_mNvkvint_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

            {
                ...
                connect (m_mNvkvint_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            }
            ...
            connect (m_nIter_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::handleChangeIteration_nIter_n_SL );
            connect (m_nIter_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            ...
            for (int n = 0; n < numOfIteration; n++)
            {
                ...
                connect (m_vNvkvint_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                ...
                connect (m_mNvkvint_n_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

                {
                    ...
                    connect (m_mNvkvint_n_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                }
            }
            ...
            connect (m_nIter_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::handleChangeIteration_nIter_k_SL );
            connect (m_nIter_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            ...
            for (int k = 0; k < numOfIteration; k++)
            {
                ...
                connect (m_qNvkvintset_k_Var,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_3_Ver340::handleIterateVariable_Q_NVKVINTSET_K_SL );
                connect (m_qNvkvintset_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                ...
                connect (m_aNvp12_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                ...
                connect (m_aNvp23_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                ...
                connect (m_vNvkvint_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                ...
                connect (m_mNvkvint_k_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

                {
                    ...
                    connect (m_mNvkvint_k_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                ...
                connect (m_nInter_k_m_Var,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_3_Ver340::handleChangeIteration_nIter_k_m_SL );
                connect (m_nInter_k_m_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                ...
                for (int m = 0; m < numOfIteration; m++)
                {
                    ...
                    connect (m_vNvkvint_k_m_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                    ...
                    connect (m_mNvkvint_k_m_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );

                    {
                        ...
                        connect (m_mNvkvint_k_m_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            ...
            connect (m_lNvkrintVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            ...
            connect (m_mNvkrintVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            ...
            connect (m_nIter_l_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::handleChangeIteration_nIter_l_SL );
            connect (m_nIter_l_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            ...
            for (int l = 0; l < numOfIteration; l++)
            {
                ...
                connect (m_lNvkrint_l_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
                ...
                connect (m_mNvkrint_l_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
            ...
            connect (m_mNvktintVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_3_Ver340::saveData );
...
void HandlerPackage_3_Ver340::show_qNvkint_SL()
{
...
void HandlerPackage_3_Ver340::show_aNVP_SL()
{
...
void HandlerPackage_3_Ver340::handleIterateVariable_aNVP_SL(QString nameVariable)
{
...
void HandlerPackage_3_Ver340::handleIterateVariable_Q_NVKVINTSET_K_SL(QString nameVariable)
{
    package::GraphicVariablePkg * p_variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    qDebug () << "nameVariable="<<nameVariable << "  Valore = "<< p_variable->valueOfVariable();
    qint16 value = p_variable->valueOfVariable().toInt();
...
void HandlerPackage_3_Ver340::handleChangeIteration_nIter_j_SL()
{
...
void HandlerPackage_3_Ver340::handleChangeIteration_nIter_n_SL()
{
...
void HandlerPackage_3_Ver340::handleChangeIteration_nIter_k_SL()
{
...
void HandlerPackage_3_Ver340::handleChangeIteration_nIter_k_m_SL(QString nomeVariabile)
{
...
void HandlerPackage_3_Ver340::handleChangeIteration_nIter_l_SL()
{
...
void HandlerPackage_3_Ver340::loadPkg()
{
...
void HandlerPackage_3_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_3_Ver340::saveData()
{
...
void HandlerPackage_3_Ver340::deleteView()
{
