#ifndef HANDLERPACKAGE_136_VER340_H
#define HANDLERPACKAGE_136_VER340_H
...
namespace package {
class HandlerPackage_136_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_136_Ver340(QObject *parent = nullptr);
