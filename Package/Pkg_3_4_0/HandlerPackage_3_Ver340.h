#ifndef HANDLERPACKAGE_3_VER340_H
#define HANDLERPACKAGE_3_VER340_H
...
namespace package {
class HandlerPackage_3_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_3_Ver340(QObject *parent = nullptr);
...
#endif // HANDLERPACKAGE_3_VER340_H
