...
HandlerPackage_16_Ver340::HandlerPackage_16_Ver340(QObject *parent)
...
bool HandlerPackage_16_Ver340::creteView()
{
    m_currCol=0;
    m_row =0;
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 16 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(40,40);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver340::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver340::saveData );
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver340::setRangeCurrent_SL );

        m_lSectionVar = new package::GraphicVariablePkg ;
        m_lSectionVar->set_L_SECTION();
        m_VariableVect.push_back(m_lSectionVar);
        connect (m_lSectionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver340::saveData );
...
void HandlerPackage_16_Ver340::loadPkg()
{
...
void HandlerPackage_16_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_16_Ver340::saveData()
{
...
void HandlerPackage_16_Ver340::deleteView()
{
    HandlerPackage::deleteView();
}

void HandlerPackage_16_Ver340::setRangeCurrent_SL()
{
