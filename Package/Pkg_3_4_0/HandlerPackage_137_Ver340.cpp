...
HandlerPackage_137_Ver340::HandlerPackage_137_Ver340(QObject *parent)
...
bool HandlerPackage_137_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 137 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_137_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(24,24);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_137_Ver340::saveData );

        m_qSrstopVar =  new package::GraphicVariablePkg ;
        m_qSrstopVar->set_Q_SRSTOP();
        m_VariableVect.push_back(m_qSrstopVar);
        connect (m_qSrstopVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_137_Ver340::saveData );
...
void HandlerPackage_137_Ver340::loadPkg()
{
...
void HandlerPackage_137_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_137_Ver340::saveData()
{
...
void HandlerPackage_137_Ver340::deleteView()
{
