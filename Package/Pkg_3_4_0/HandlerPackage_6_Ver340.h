#ifndef HANDLERPACKAGE_6_VER340_H
#define HANDLERPACKAGE_6_VER340_H
...
namespace package {
class HandlerPackage_6_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_6_Ver340(QObject *parent = nullptr);
...
#endif // HANDLERPACKAGE_6_VER340_H
