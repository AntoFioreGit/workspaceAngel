...
HandlerPackage_15_Ver340::HandlerPackage_15_Ver340(QObject *parent)
...
bool HandlerPackage_15_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 15 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(66,1456);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );

        m_vLoaVar = new package::GraphicVariablePkg ;
        m_vLoaVar->set_V_EMA();
        m_vLoaVar->setNameVariable("V_LOA");
        m_VariableVect.push_back(m_vLoaVar);
        connect (m_vLoaVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );

        m_tLoaVar = new package::GraphicVariablePkg ;
        m_tLoaVar->set_T_EMA();
        m_tLoaVar->setNameVariable("T_LOA");
        m_VariableVect.push_back(m_tLoaVar);
        connect (m_tLoaVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );

        m_nIterVar = new package::GraphicVariablePkg ;
        m_nIterVar->set_N_ITER();
        m_VariableVect.push_back(m_nIterVar);
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::handleChangeIteration_SL );
        ...
        for (int i = 0;i < maxValueVariableIter ;i++)
        {
            ...
            connect (m_lSection_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
            ...
            connect (m_qSectiontimer_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
            connect (m_qSectiontimer_n_Var,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_15_Ver340::handleIterateVariable_SL);

            {
                ...
                connect (m_tSectiontimer_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
                ...
                connect (m_dSectiontierstoploc_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
            }
        ...
        connect (m_lEndsectionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
        ...
        connect (m_qSectiontimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
        connect (m_qSectiontimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::show_SECTION_SL );

        {
            ...
            connect (m_tSectiontimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
            ...
            connect (m_dSectiontimerstoplocVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );

        }
        m_qEndtimerVar = new package::GraphicVariablePkg ;
        m_qEndtimerVar->set_Q_ENDTIMER();
        m_VariableVect.push_back(m_qEndtimerVar);
        connect (m_qEndtimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
        connect (m_qEndtimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::show_ENDTIMER_SL );

        {
            ...
            connect (m_tEndtimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
            ...
            connect (m_dEndtimerstartlocVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
        ...
        connect (m_qDangerpointVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
        connect (m_qDangerpointVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::show_DP_SL );

        {
            ...
            connect (m_dDpVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
            ...
            connect (m_vReleasedpVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
        ...
        connect (m_qOverlapVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
        connect (m_qOverlapVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::show_OL_SL );

        {
            ...
            connect (m_dStartolVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );

            m_tOlVar = new package::GraphicVariablePkg ;
            m_tOlVar->set_T_OL();
            m_tOlVar->setTobeVisible(false);
            m_VariableVect.push_back(m_tOlVar);
            connect (m_tOlVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );

            m_dOlVar = new package::GraphicVariablePkg ;
            m_dOlVar->set_D_OL();
            m_dOlVar->setTobeVisible(false);
            m_VariableVect.push_back(m_dOlVar);
            connect (m_dOlVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
            ...
            connect (m_vReleaseolVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_15_Ver340::saveData );
...
void HandlerPackage_15_Ver340::loadPkg()
{
...
void HandlerPackage_15_Ver340::handleChangeIteration_SL()
{
...
void HandlerPackage_15_Ver340::show_SECTION_SL()
{
...
void HandlerPackage_15_Ver340::show_ENDTIMER_SL()
{
...
void HandlerPackage_15_Ver340::show_DP_SL()
{
...
void HandlerPackage_15_Ver340::show_OL_SL()
{
...
void HandlerPackage_15_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
void HandlerPackage_15_Ver340::handleIterateVariable_SL(QString nameVariable)
{
...
bool HandlerPackage_15_Ver340::saveData()
{
...
void HandlerPackage_15_Ver340::deleteView()
{
