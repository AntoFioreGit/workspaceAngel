#ifndef HANDLERPACKAGE_138_VER340_H
#define HANDLERPACKAGE_138_VER340_H
...
namespace package {
class HandlerPackage_138_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_138_Ver340(QObject *parent = nullptr);
...
private:
    ...
    package::GraphicVariablePkg *m_dStartreverseVar;
    package::GraphicVariablePkg *m_lReverseareaVar;
