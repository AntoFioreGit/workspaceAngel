...
HandlerPackage_42_Ver340::HandlerPackage_42_Ver340(QObject *parent)
...
bool HandlerPackage_42_Ver340::creteView()
{

    qDebug () << "HandlerPackage_40_Ver340::creteView();";
    bool ret = false;
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 42 - " + QString(BASELINE_3_4_0));
        ...
        showVariable();
        connect (m_SleepSessionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_42_Ver340::saveData );
        connect (m_nidRadioVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_42_Ver340::saveData );
        connect (m_nidRbcVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_42_Ver340::saveData );
        connect (m_nidCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_42_Ver340::saveData );
        connect (m_qRbcVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_42_Ver340::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_42_Ver340::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_42_Ver340::saveData );
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_42_Ver340::saveData );
...
void HandlerPackage_42_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_42_Ver340::saveData()
{
...
void HandlerPackage_42_Ver340::deleteView()
{
...
void HandlerPackage_42_Ver340::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
