...
HandlerPackage_141_Ver340::HandlerPackage_141_Ver340(QObject *parent)
...
bool HandlerPackage_141_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 141 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_141_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(55,55);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_141_Ver340::saveData );

        m_qGdirVar = new package::GraphicVariablePkg;
        m_qGdirVar->set_Q_GDIR();
        m_VariableVect.push_back(m_qGdirVar);
        connect (m_qGdirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_141_Ver340::saveData );

        m_gTsrVar = new package::GraphicVariablePkg;
        m_gTsrVar->set_G_TSR();
        m_VariableVect.push_back(m_gTsrVar);
        connect (m_gTsrVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_141_Ver340::saveData );
...
void HandlerPackage_141_Ver340::loadPkg()
{
...
void HandlerPackage_141_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_141_Ver340::saveData()
{
...
void HandlerPackage_141_Ver340::deleteView()
{
