#ifndef HANDLERPACKAGE_131_VER340_H
#define HANDLERPACKAGE_131_VER340_H
...
namespace package {
class HandlerPackage_131_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_131_Ver340(QObject *parent = nullptr);
