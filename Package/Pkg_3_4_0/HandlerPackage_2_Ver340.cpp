...
HandlerPackage_2_Ver340::HandlerPackage_2_Ver340(QObject *parent)
...
bool HandlerPackage_2_Ver340::creteView()
{

    qDebug () << "HandlerPackage_2_Ver340::creteView();";

    if (nullptr != m_layOutPkg){

        m_titlePkg = new package::GraphicTitlePkg;
        m_titlePkg->init("Packet 2 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_2_Ver340::saveData );


        m_qDirVar =  new package::GraphicVariablePkg;
        m_qDirVar->set_Q_DIR();
        m_VariableVect.push_back(m_qDirVar);
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_2_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg;
        m_lenPkgVar->set_L_PACKET(30, 30);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_2_Ver340::saveData );

        m_versionVar =  new package::GraphicVariablePkg;
        m_versionVar->set_M_VERSION();
        m_VariableVect.push_back(m_versionVar);
        connect (m_versionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_2_Ver340::saveData );
...
bool HandlerPackage_2_Ver340::saveData()
{
...
void HandlerPackage_2_Ver340::deleteView()
{
...
void HandlerPackage_2_Ver340::loadPkg()
{
