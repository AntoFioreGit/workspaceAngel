...
HandlerPackage_39_Ver340::HandlerPackage_39_Ver340(QObject *parent)
...
bool HandlerPackage_39_Ver340::creteView()
{

    qDebug () << "HandlerPackage_39_Ver340::creteView();";

    if (nullptr != m_layOutPkg){

        m_titlePkg = new package::GraphicTitlePkg;
        m_titlePkg->init("Packet 39 - " + QString(BASELINE_3_4_0));
...
//        m_layOutPkg->addItem(m_spaced,++row,4);
    ...
    connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_39_Ver340::saveData );
    connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_39_Ver340::saveData );
    connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_39_Ver340::saveData );
    connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_39_Ver340::saveData );


    connect (m_dTractionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_39_Ver340::saveData );

    connect (m_mVoltageVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_39_Ver340::saveData );
     connect (m_mVoltageVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_39_Ver340::showNidCtraction );

    connect (m_nidCtractionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_39_Ver340::saveData );

    return true;

}

bool HandlerPackage_39_Ver340::saveData()
{
...
void HandlerPackage_39_Ver340::deleteView()
{
...
void HandlerPackage_39_Ver340::loadPkg()
{
...
void HandlerPackage_39_Ver340::showNidCtraction()
{
...
void HandlerPackage_39_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
