...
HandlerPackage_79_Ver340::HandlerPackage_79_Ver340(QObject *parent)
...
bool HandlerPackage_79_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 79 - " + QString(BASELINE_3_4_0));
    ...
    connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
    connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
    connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
    connect (m_ScaleVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_79_Ver340::handleChangeScaleVariable_SL );
    connect (m_ScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );

    connect (m_qNewCountryVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_79_Ver340::handleChangeQ_NewCountryVariable_SL );
    connect (m_qNewCountryVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
    connect (m_NidCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
    connect (m_nidBgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );

    connect (m_dPosOffVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
    connect (m_qMPositionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
    connect (m_MPositionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
    connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::handleChangeIteration_SL );
    connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
    ...
    for (int i = positionIterateVar ;i < size ;i++) {
        ...
        if (nullptr != variable){
            ...
            if (variable->internalName().contains("Q_NEWCOUNTRY_")){
                connect (variable,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_79_Ver340::handleChangeQ_NewCountryIterVariable_SL );
            }
            connect (variable,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_79_Ver340::saveData );
        }
...
void HandlerPackage_79_Ver340::handleChangeIteration_SL()
{
...
void HandlerPackage_79_Ver340::handleChangeScaleVariable_SL(QString nameVariable)
{
...
void HandlerPackage_79_Ver340::handleChangeQ_NewCountryVariable_SL(QString nameVariable)
{
    package::GraphicVariablePkg * variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
     if (nullptr != variable){
...
void HandlerPackage_79_Ver340::handleChangeQ_NewCountryIterVariable_SL(QString nameVariable)
{
    package::GraphicVariablePkg * variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    if (nullptr != variable){
...
void HandlerPackage_79_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_79_Ver340::saveData()
{
    QString data;
...
void HandlerPackage_79_Ver340::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
...
void HandlerPackage_79_Ver340::deleteView()
{
