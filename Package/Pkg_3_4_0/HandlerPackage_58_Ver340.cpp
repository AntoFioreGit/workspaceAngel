...
HandlerPackage_58_Ver340::HandlerPackage_58_Ver340(QObject *parent)
...
bool HandlerPackage_58_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 58 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::saveData );

        m_lenPkgVar = new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(49, 552);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::saveData );
        ...
        connect (m_tCyclocVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::saveData );
        ...
        connect (m_dCyclocVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::saveData );
        ...
        connect (m_mLocVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::saveData );

        m_nIterVar = new package::GraphicVariablePkg ;
        m_nIterVar->set_N_ITER();
        m_VariableVect.push_back(m_nIterVar);
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::saveData );
        ...
        for (int n = 0; n < maxValueVariableIter_n ; n++)
        {
            ...
            connect (m_dLoc_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::saveData );
            ...
            connect (m_qLgtloc_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_58_Ver340::saveData );
        }
...
void HandlerPackage_58_Ver340::handleChangeIteration_SL()
{
...
void HandlerPackage_58_Ver340::loadPkg()
{
...
void HandlerPackage_58_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_58_Ver340::saveData()
{
...
void HandlerPackage_58_Ver340::deleteView()
{
