#ifndef HANDLERPACKAGE_135_VER340_H
#define HANDLERPACKAGE_135_VER340_H
...
namespace package {
class HandlerPackage_135_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_135_Ver340(QObject *parent = nullptr);
