...
HandlerPackage_135_Ver340::HandlerPackage_135_Ver340(QObject *parent)
...
bool HandlerPackage_135_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 135 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_135_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(23,23);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_135_Ver340::saveData );
...
void HandlerPackage_135_Ver340::loadPkg()
{
...
void HandlerPackage_135_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_135_Ver340::saveData()
{
...
void HandlerPackage_135_Ver340::deleteView()
{
