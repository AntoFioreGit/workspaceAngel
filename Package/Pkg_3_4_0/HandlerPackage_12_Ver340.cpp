...
HandlerPackage_12_Ver340::HandlerPackage_12_Ver340(QObject *parent)
...
bool HandlerPackage_12_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 12 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(72, 1462);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );

        m_qScaleVar =  new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        ...
        connect (m_vMainVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );

        m_vLoaVar =  new package::GraphicVariablePkg ;
        m_vLoaVar->init(GraphicVariablePkg::type_integer);
        m_vLoaVar->setNameVariable("V_LOA");
        m_vLoaVar->setRange(0,600);
        m_vLoaVar->setDefaultValue(0);
        m_vLoaVar->setVisible(false);
        m_vLoaVar->setTobeVisible(true);
        m_vLoaVar->setVariableBitSize(7);
        m_VariableVect.push_back(m_vLoaVar);
        connect (m_vLoaVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );

        m_tLoaVar =  new package::GraphicVariablePkg ;
        m_tLoaVar->init(GraphicVariablePkg::type_integer);
        m_tLoaVar->setNameVariable("T_LOA");
        m_tLoaVar->setRange(0,600);
        m_tLoaVar->setDefaultValue(0);
        m_tLoaVar->setVisible(false);
        m_tLoaVar->setTobeVisible(true);
        m_tLoaVar->setVariableBitSize(10);
        m_VariableVect.push_back(m_tLoaVar);
        connect (m_tLoaVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );

        m_nIterVar =  new package::GraphicVariablePkg ;
        m_nIterVar->set_N_ITER();
        m_VariableVect.push_back(m_nIterVar);
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        ...
        for (int i = 0;i < maxValueVariableIter ;i++)
        {
            ...
            connect (p_lSectionVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
            ...
            connect (p_qSectionTimerVar_k,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_12_Ver340::handleIterateVariable_SL );
            connect (p_qSectionTimerVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );

            {
                ...
                connect (p_tSectionTimerVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
                ...
                connect (p_dSectionTimerStopLocVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
            }
        }
        ...
        connect (m_lEndSectionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        ...
        connect (m_qSectionTimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::show_qSectionTimer_SL );
        connect (m_qSectionTimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        ...
        {   /* window for L_ENDSECTION */
            ...
            connect (m_tSectionTimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
            ...
            connect (m_dSectionTimerStopLocVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        }
        ...
        connect (m_qEndTimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::show_qEndTimer_SL );
        connect (m_qEndTimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        ...
        {   /* window for Q_ENDTIMER */
            ...
            connect (m_tEndTimerVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
            ...
            connect (m_dEndTimerStartLocVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        }
        ...
        connect (m_qDangerPointVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::show_qDangerPoint_SL );
        connect (m_qDangerPointVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        ...
        {   /* window for Q_DANGERPOINT */
            ...
            connect (m_dDpVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
            ...
            connect (m_vReleaseDpVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        }
        ...
        connect (m_qOverlapVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::show_qOverlap_SL );
        connect (m_qOverlapVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        ...
        {   /* window for Q_DANGERPOINT */
            ...
            connect (m_dStartOLVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
            ...
            connect (m_tOLVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
            ...
            connect (m_dOLVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
            ...
            connect (m_vReleaseOLVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_12_Ver340::saveData );
        }
...
void HandlerPackage_12_Ver340::loadPkg()
{
...
void HandlerPackage_12_Ver340::show_qSectionTimer_SL()
{
...
void HandlerPackage_12_Ver340::show_qEndTimer_SL()
{
...
void HandlerPackage_12_Ver340::show_qDangerPoint_SL()
{
...
void HandlerPackage_12_Ver340::show_qOverlap_SL()
{
...
void HandlerPackage_12_Ver340::handleChangeIteration_SL()
{
...
void HandlerPackage_12_Ver340::handleIterateVariable_SL(QString nameVariable)
{
...
void HandlerPackage_12_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_12_Ver340::saveData()
{
...
void HandlerPackage_12_Ver340::deleteView()
{
