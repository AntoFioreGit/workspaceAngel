...
HandlerPackage_27_Ver340::HandlerPackage_27_Ver340(QObject *parent)
...
bool HandlerPackage_27_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 27 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(58, 17790);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );

        m_dStaticVar =  new package::GraphicVariablePkg;
        m_dStaticVar->set_D_STATIC();
        m_VariableVect.push_back(m_dStaticVar);
        connect (m_dStaticVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
        ...
        connect (m_vStaticVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );

        m_qFrontVar =  new package::GraphicVariablePkg;
        m_qFrontVar->set_Q_FRONT();
        m_VariableVect.push_back(m_qFrontVar);
        connect (m_qFrontVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
        ...
        connect (m_nIter_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::handleChangeIteration_n_SL );
        connect (m_nIter_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
        ...
        for (int i = 0;i < maxValueVariableIter ;i++)
        {
            ...
            connect (m_qDiff_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
            connect (m_qDiff_n_Var,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_27_Ver340::handleIterateVariable_SL);

            {
                ...
                connect (m_nc_cDdiff_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
                ...
                connect (m_nc_Diff_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
            }
            ...
            connect (m_vDiff_n_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
        ...
        connect (m_nIter_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::handleChangeIteration_k_SL );
        connect (m_nIter_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
        ...
        for (int i = 0;i < maxValueVariableIter ;i++)
        {
            ...
            connect (m_dStatic_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
            ...
            connect (m_vStatic_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
            ...
            connect (m_qFront_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
            ...
            connect (m_nIter_m_Var,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_27_Ver340::handleChangeIteration_k_m_SL );
            connect (m_nIter_m_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
            ...
            for (int j = 0;j < maxValueVariableIter ;j++)
            {
                ...
                connect (m_qDiff_km_Var,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_27_Ver340::handleIterateVariable_k_m_SL);
                connect (m_qDiff_km_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );

                {
                    ...
                    connect (m_ncCddiff_km_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
                    ...
                    connect (m_ncDiff_km_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
                }
                ...
                connect (m_vDiff_km_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_27_Ver340::saveData );
...
void HandlerPackage_27_Ver340::loadPkg()
{
...
void HandlerPackage_27_Ver340::handleChangeIteration_n_SL()
{
...
void HandlerPackage_27_Ver340::handleChangeIteration_k_SL()
{
...
void HandlerPackage_27_Ver340::handleChangeIteration_k_m_SL(QString nameVariable)
{
...
void HandlerPackage_27_Ver340::handleIterateVariable_SL(QString nameVariable)
{
    package::GraphicVariablePkg * p_variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    qDebug () << "nameVariable="<<nameVariable << "  Valore = "<< p_variable->valueOfVariable();
...
void HandlerPackage_27_Ver340::handleIterateVariable_k_m_SL(QString nameVariable)
{
    package::GraphicVariablePkg * p_variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    qDebug () << "nameVariable="<<nameVariable << "  Valore = "<< p_variable->valueOfVariable();
    qint16 value = p_variable->valueOfVariable().toInt();
...
void HandlerPackage_27_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_27_Ver340::saveData()
{
...
void HandlerPackage_27_Ver340::deleteView()
{
