#ifndef HANDLERPACKAGE_12_VER340_H
#define HANDLERPACKAGE_12_VER340_H
...
namespace package {
class HandlerPackage_12_Ver340 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_12_Ver340(QObject *parent = nullptr);
