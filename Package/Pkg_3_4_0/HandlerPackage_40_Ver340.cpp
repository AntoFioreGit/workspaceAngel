...
HandlerPackage_40_Ver340::HandlerPackage_40_Ver340(QObject *parent)
...
bool HandlerPackage_40_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 40 - " + QString(BASELINE_3_4_0));
        ...
        showVariable();
        connect (m_mCurrent,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_40_Ver340::saveData );
        connect (m_dCurrent,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_40_Ver340::saveData );
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_40_Ver340::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_40_Ver340::saveData );
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_40_Ver340::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_40_Ver340::saveData );
        ret=true;
    }
...
void HandlerPackage_40_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_40_Ver340::saveData()
{
...
void HandlerPackage_40_Ver340::deleteView()
{
...
void HandlerPackage_40_Ver340::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
