...
HandlerPackage_134_Ver340::HandlerPackage_134_Ver340(QObject *parent)
...
bool HandlerPackage_134_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 134 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_134_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(72, 1462);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_134_Ver340::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_134_Ver340::saveData );

        m_nidLoopVar = new package::GraphicVariablePkg ;
        m_nidLoopVar->set_NID_LOOP();
        m_VariableVect.push_back(m_nidLoopVar);
        connect (m_nidLoopVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_134_Ver340::saveData );

        m_dLoopVar = new package::GraphicVariablePkg ;
        m_dLoopVar->set_D_LOOP();
        m_VariableVect.push_back(m_dLoopVar);
        connect (m_dLoopVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_134_Ver340::saveData );

        m_lLoopVar = new package::GraphicVariablePkg ;
        m_lLoopVar->set_L_LOOP();
        m_VariableVect.push_back(m_lLoopVar);
        connect (m_lLoopVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_134_Ver340::saveData );

        m_qLoopdirVar = new package::GraphicVariablePkg ;
        m_qLoopdirVar->set_Q_LOOPDIR();
        m_VariableVect.push_back(m_qLoopdirVar);
        connect (m_qLoopdirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_134_Ver340::saveData );

        m_qSscodeVar = new package::GraphicVariablePkg ;
        m_qSscodeVar->set_Q_SSCODE();
        m_VariableVect.push_back(m_qSscodeVar);
        connect (m_qSscodeVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_134_Ver340::saveData );
...
void HandlerPackage_134_Ver340::loadPkg()
{
...
void HandlerPackage_134_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_134_Ver340::saveData()
{
...
void HandlerPackage_134_Ver340::deleteView()
{
