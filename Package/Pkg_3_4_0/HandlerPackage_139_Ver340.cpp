...
HandlerPackage_139_Ver340::HandlerPackage_139_Ver340(QObject *parent)
...
bool HandlerPackage_139_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 139 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_139_Ver340::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(55,55);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_139_Ver340::saveData );


        m_qScaleVar =  new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_139_Ver340::saveData );

        m_dReverseVar =  new package::GraphicVariablePkg ;
        m_dReverseVar->set_D_REVERSE();
        m_VariableVect.push_back(m_dReverseVar);
        connect (m_dReverseVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_139_Ver340::saveData );

        m_vReverseVar =  new package::GraphicVariablePkg ;
        m_vReverseVar->set_V_REVERSE();
        m_VariableVect.push_back(m_vReverseVar);
        connect (m_vReverseVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_139_Ver340::saveData );
...
void HandlerPackage_139_Ver340::loadPkg()
{
...
void HandlerPackage_139_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_139_Ver340::saveData()
{
...
void HandlerPackage_139_Ver340::deleteView()
{
