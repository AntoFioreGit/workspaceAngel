...
HandlerPackage_5_Ver340::HandlerPackage_5_Ver340(QObject *parent)
...
bool HandlerPackage_5_Ver340::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 5 - " + QString(BASELINE_3_4_0));
        ...
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_dLinkVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_qNewcountryVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::show_nidC );
        connect (m_qNewcountryVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_nidCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_qLinkorientationVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_nidBGVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_qLinkorientationVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        connect (m_qLocaccVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );

        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
        ...
        for (int i = 0;i < maxValueVariableIter ;i++) {
            ...
            connect (m_dLinkVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
            connect (m_qNewcountryVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
            connect (m_qNewcountryVar_k,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_5_Ver340::handleIterateVariable_SL);
            connect (m_nidCVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );            
            connect (m_nidBGVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
            connect (m_qLinkorientationVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
            connect (m_qLinkorientationVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
            connect (m_qLocaccVar_k,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_5_Ver340::saveData );
...
void HandlerPackage_5_Ver340::show_nidC()
{
...
void HandlerPackage_5_Ver340::handleIterateVariable_SL(QString nameVariable)
{
...
void HandlerPackage_5_Ver340::show_nidC_k()
{
...
void HandlerPackage_5_Ver340::handleChangeIteration_SL()
{
...
void HandlerPackage_5_Ver340::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_5_Ver340::saveData()
{
...
void HandlerPackage_5_Ver340::deleteView()
{
...
void HandlerPackage_5_Ver340::loadPkg()
{
