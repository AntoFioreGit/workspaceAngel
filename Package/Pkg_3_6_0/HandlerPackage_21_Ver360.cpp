...
HandlerPackage_21_Ver360::HandlerPackage_21_Ver360(QObject *parent)
...
bool HandlerPackage_21_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 21 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(58, 780);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );
        ...
        connect (m_dGradientVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );
        ...
        connect (m_qGdirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );
        ...
        connect (m_GAVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );

        m_nIterVar =  new package::GraphicVariablePkg ;
        m_nIterVar->set_N_ITER();
        m_VariableVect.push_back(m_nIterVar);
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );
        ...
        for (int i = 0;i < maxValueVariableIter ;i++)
        {
            ...
            connect (m_dGradient_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );
            ...
            connect (m_qGdir_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );
            ...
            connect (m_GA_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_21_Ver360::saveData );
        }
...
void HandlerPackage_21_Ver360::loadPkg()
{
...
void HandlerPackage_21_Ver360::handleChangeIteration_SL()
{
...
void HandlerPackage_21_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_21_Ver360::saveData()
{
...
void HandlerPackage_21_Ver360::deleteView()
{
