#ifndef HANDLERPACKAGE_138_VER360_H
#define HANDLERPACKAGE_138_VER360_H
...
namespace package {
class HandlerPackage_138_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_138_Ver360(QObject *parent = nullptr);
