...
HandlerPackage_133_Ver360::HandlerPackage_133_Ver360(QObject *parent)
...
bool HandlerPackage_133_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 133 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(153,153);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );

        m_qScaleVar =  new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );

        m_qRiuVar =  new package::GraphicVariablePkg ;
        m_qRiuVar->set_Q_RIU();
        m_VariableVect.push_back(m_qRiuVar);
        connect (m_qRiuVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );
        ...
        connect (m_nidC_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );

        m_nidRiuVar =  new package::GraphicVariablePkg ;
        m_nidRiuVar->set_NID_RIU();
        m_VariableVect.push_back(m_nidRiuVar);
        connect (m_nidRiuVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );

        m_nidRadioVar =  new package::GraphicVariablePkg ;
        m_nidRadioVar->set_NID_RADIO();
        m_VariableVect.push_back(m_nidRadioVar);
        connect (m_nidRadioVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );

        m_dInfillVar =  new package::GraphicVariablePkg ;
        m_dInfillVar->set_D_INFILL();
        m_VariableVect.push_back(m_dInfillVar);
        connect (m_dInfillVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );
        ...
        connect (m_nidC_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );

        m_nidBgVar =  new package::GraphicVariablePkg ;
        m_nidBgVar->set_NID_BG();
        m_VariableVect.push_back(m_nidBgVar);
        connect (m_nidBgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_133_Ver360::saveData );
...
void HandlerPackage_133_Ver360::loadPkg()
{
...
void HandlerPackage_133_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_133_Ver360::saveData()
{
...
void HandlerPackage_133_Ver360::deleteView()
{
