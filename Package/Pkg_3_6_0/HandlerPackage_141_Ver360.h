#ifndef HANDLERPACKAGE_141_VER360_H
#define HANDLERPACKAGE_141_VER360_H
...
namespace package {
class HandlerPackage_141_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_141_Ver360(QObject *parent = nullptr);
