#ifndef HANDLERPACKAGE_72_VER360_H
#define HANDLERPACKAGE_72_VER360_H
...
namespace package {
class HandlerPackage_72_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_72_Ver360(QObject *parent = nullptr);
