#ifndef HANDLERPACKAGE_139_VER360_H
#define HANDLERPACKAGE_139_VER360_H
...
namespace package {
class HandlerPackage_139_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_139_Ver360(QObject *parent = nullptr);
