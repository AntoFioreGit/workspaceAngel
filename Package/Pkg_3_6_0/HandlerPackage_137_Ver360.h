#ifndef HANDLERPACKAGE_137_VER360_H
#define HANDLERPACKAGE_137_VER360_H
...
namespace package {
class HandlerPackage_137_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_137_Ver360(QObject *parent = nullptr);
