...
HandlerPackage_141_Ver360::HandlerPackage_141_Ver360(QObject *parent)
...
bool HandlerPackage_141_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 141 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_141_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(55,55);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_141_Ver360::saveData );

        m_qGdirVar = new package::GraphicVariablePkg;
        m_qGdirVar->set_Q_GDIR();
        m_VariableVect.push_back(m_qGdirVar);
        connect (m_qGdirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_141_Ver360::saveData );

        m_gTsrVar = new package::GraphicVariablePkg;
        m_gTsrVar->set_G_TSR();
        m_VariableVect.push_back(m_gTsrVar);
        connect (m_gTsrVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_141_Ver360::saveData );
...
void HandlerPackage_141_Ver360::loadPkg()
{
...
void HandlerPackage_141_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_141_Ver360::saveData()
{
...
void HandlerPackage_141_Ver360::deleteView()
{
