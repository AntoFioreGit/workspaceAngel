...
HandlerPackage_44_Ver360::HandlerPackage_44_Ver360(QObject *parent)
...
bool HandlerPackage_44_Ver360::creteView()
{
    bool ret = false;
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 44 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_44_Ver360::saveData );
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_44_Ver360::saveData );
        ...
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_44_Ver360::saveData );
        ...
        connect (m_NidXUserVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_44_Ver360::saveData );
        connect (m_NidXUserVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_44_Ver360::showNid_Ntc_SL );
        ...
        connect (m_NidNtcVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_44_Ver360::saveData );
...
void HandlerPackage_44_Ver360::showNid_Ntc_SL()
{
...
void HandlerPackage_44_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_44_Ver360::saveData()
{
...
void HandlerPackage_44_Ver360::deleteView()
{
    HandlerPackage::deleteView();
}

void HandlerPackage_44_Ver360::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
