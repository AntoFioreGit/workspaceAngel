...
HandlerPackage_80_Ver360::HandlerPackage_80_Ver360(QObject *parent)
...
bool HandlerPackage_80_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 80 - " + QString(BASELINE_3_6_0));
        ...
        showVariable();
        ret = saveData();
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
        connect (m_ScaleVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_80_Ver360::handleChangeScaleVariable_SL );
        connect (m_ScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );

        connect (m_dMaModeVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
        connect (m_mMaModeVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
        connect (m_vMaModeVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );

        connect (m_lMaModeVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
        connect (m_lAckMaModeVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
        connect (m_qMaModeVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
        ...
        for (int i = positionIterateVar ;i < size ;i++) {
            ...
            if (nullptr != variable){
                connect (variable,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_80_Ver360::saveData );
            }
        }
    }
    return ret;
...
void HandlerPackage_80_Ver360::handleChangeIteration_SL()
{
...
void HandlerPackage_80_Ver360::handleChangeScaleVariable_SL(QString nameVariable)
{
...
void HandlerPackage_80_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_80_Ver360::saveData()
{
    QString data;
...
void HandlerPackage_80_Ver360::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
...
void HandlerPackage_80_Ver360::deleteView()
{
