#ifndef HANDLERPACKAGE_51_VER360_H
#define HANDLERPACKAGE_51_VER360_H
...
namespace package {
class HandlerPackage_51_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_51_Ver360(QObject *parent = nullptr);
