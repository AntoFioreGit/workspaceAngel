...
HandlerPackage_49_Ver360::HandlerPackage_49_Ver360(QObject *parent)
...
bool HandlerPackage_49_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 49 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_49_Ver360::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_49_Ver360::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_49_Ver360::saveData );

        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_49_Ver360::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_49_Ver360::saveData );
        ...
        for (int i = positionIterateVar ;i < size ;i++) {
            ...
            if (nullptr != variable){
                connect (variable,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_49_Ver360::saveData );
                if (variable->internalName().contains("Q_NEWCOUNTRY_")){
                    connect (variable,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_49_Ver360::handleChangeQ_NewCountry_IterVariable_SL );
                }
            }
...
void HandlerPackage_49_Ver360::handleChangeIteration_SL()
{
...
void HandlerPackage_49_Ver360::handleChangeQ_NewCountry_IterVariable_SL(QString nameVariable)
{
...
void HandlerPackage_49_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_49_Ver360::saveData()
{
    QString data;
...
void HandlerPackage_49_Ver360::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
...
void HandlerPackage_49_Ver360::deleteView()
{
