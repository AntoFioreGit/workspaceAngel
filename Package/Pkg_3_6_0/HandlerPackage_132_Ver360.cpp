...
HandlerPackage_132_Ver360::HandlerPackage_132_Ver360(QObject *parent)
...
bool HandlerPackage_132_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 132 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_132_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(24,24);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_132_Ver360::saveData );

        m_qAspectVar =  new package::GraphicVariablePkg ;
        m_qAspectVar->set_Q_ASPECT();
        m_VariableVect.push_back(m_qAspectVar);
        connect (m_qAspectVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_132_Ver360::saveData );
...
void HandlerPackage_132_Ver360::loadPkg()
{
...
void HandlerPackage_132_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_132_Ver360::saveData()
{
...
void HandlerPackage_132_Ver360::deleteView()
{
