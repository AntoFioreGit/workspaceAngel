...
HandlerPackage_88_Ver360::HandlerPackage_88_Ver360(QObject *parent)
...
bool HandlerPackage_88_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 88 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(57,80);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );

        m_qScaleVar =  new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );


        m_nidLxVar =  new package::GraphicVariablePkg ;
        m_nidLxVar->set_NID_LX();
        m_VariableVect.push_back(m_nidLxVar);
        connect (m_nidLxVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );

        m_dLxVar =  new package::GraphicVariablePkg ;
        m_dLxVar->set_D_LX();
        m_VariableVect.push_back(m_dLxVar);
        connect (m_dLxVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );

        m_lLxVar =  new package::GraphicVariablePkg ;
        m_lLxVar->set_L_LX();
        m_VariableVect.push_back(m_lLxVar);
        connect (m_lLxVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );

        m_qLxstatusVar =  new package::GraphicVariablePkg ;
        m_qLxstatusVar->set_Q_LXSTATUS();
        m_VariableVect.push_back(m_qLxstatusVar);
        connect (m_qLxstatusVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );
        connect (m_qLxstatusVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::show_VLX_QSTOPLX_SL );

        m_vLxVar =  new package::GraphicVariablePkg ;
        m_vLxVar->set_V_LX();
        m_vLxVar->setTobeVisible(false);
        m_VariableVect.push_back(m_vLxVar);
        connect (m_vLxVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );
        ...
        connect (m_qStoplxVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );
        connect (m_qStoplxVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::show_LSTOPLX_SL );
        ...
        connect (m_lStoplxVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_88_Ver360::saveData );
...
void HandlerPackage_88_Ver360::show_LSTOPLX_SL()
{
...
void HandlerPackage_88_Ver360::show_VLX_QSTOPLX_SL()
{
...
void HandlerPackage_88_Ver360::loadPkg()
{
...
void HandlerPackage_88_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_88_Ver360::saveData()
{
...
void HandlerPackage_88_Ver360::deleteView()
{
