...
HandlerPackage_71_Ver360::HandlerPackage_71_Ver360(QObject *parent)
...
bool HandlerPackage_71_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 71 - " + QString(BASELINE_3_6_0));
        ...
        showVariable();
        ret=saveData();
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_71_Ver360::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_71_Ver360::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_71_Ver360::saveData );
        connect (m_ScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_71_Ver360::saveData );
        connect (m_dAdhesionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_71_Ver360::saveData );
        connect (m_lAdhesionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_71_Ver360::saveData );
        connect (m_mAdhesionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_71_Ver360::saveData );
    }
...
void HandlerPackage_71_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_71_Ver360::saveData()
{
    QString data;
...
void HandlerPackage_71_Ver360::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
...
void HandlerPackage_71_Ver360::deleteView()
{
