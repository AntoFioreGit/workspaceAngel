#ifndef HANDLERPACKAGE_133_VER360_H
#define HANDLERPACKAGE_133_VER360_H
...
namespace package {
class HandlerPackage_133_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_133_Ver360(QObject *parent = nullptr);
