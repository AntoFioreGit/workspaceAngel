...
HandlerPackage_70_Ver360::HandlerPackage_70_Ver360(QObject *parent)
...
bool HandlerPackage_70_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 70 - " + QString(BASELINE_3_6_0));
        ...
        showVariable();
        ret=saveData();
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );
        connect (m_ScaleVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_70_Ver360::handleChangeScaleVariable_SL );
        connect (m_ScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );

        connect (m_qTrackInitVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_70_Ver360::handleChangeQ_TrackInitVariable_SL );
        connect (m_qTrackInitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );

        connect (m_dSuitabilityVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );


        connect (m_qSuitabilityVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_70_Ver360::handleChangeQ_SUITABILITYVariable_SL );
        connect (m_qSuitabilityVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );


        connect (m_mLineGaugeVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );
        connect (m_mAxleloadcatVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );

        connect (m_mVoltageVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_70_Ver360::handleChangeM_Voltage_SL );
        connect (m_mVoltageVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );

        connect (m_nid_CtractionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );

        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );
        ...
        for (int i = positionIterateVar ;i < size ;i++) {
            ...
            if (nullptr != variable){
                connect (variable,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_70_Ver360::saveData );
                if (variable->internalName().contains("Q_SUITABILITY_")){
                    connect (variable,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_70_Ver360::handleChangeQ_SUITABILITY_IterVariable_SL );
                } else if (variable->internalName().contains("M_VOLTAGE_")){
                   connect (variable,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_70_Ver360::handleChangeM_VoltageIterVariable_SL );
                }
            }
...
void HandlerPackage_70_Ver360::handleChangeIteration_SL()
{
...
void HandlerPackage_70_Ver360::handleChangeScaleVariable_SL(QString nameVariable)
{
...
void HandlerPackage_70_Ver360::handleChangeQ_TrackInitVariable_SL(QString nameVariable)
{
    package::GraphicVariablePkg * variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    if (nullptr != variable){
        qint16 value = variable->valueOfVariable().toInt();
...
void HandlerPackage_70_Ver360::handleChangeQ_SUITABILITYVariable_SL(QString nameVariable)
{
...
void HandlerPackage_70_Ver360::handleChangeM_Voltage_SL(QString nameVariable)
{
    package::GraphicVariablePkg * variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    if (nullptr != variable){
...
void HandlerPackage_70_Ver360::handleChangeQ_SUITABILITY_IterVariable_SL(QString nameVariable)
{
...
void HandlerPackage_70_Ver360::handleChangeM_VoltageIterVariable_SL(QString nameVariable)
{
    package::GraphicVariablePkg * variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    if (nullptr != variable){
         QStringList parseNameVar = nameVariable.split("_");
...
void HandlerPackage_70_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_70_Ver360::saveData()
{
    QString data;
...
void HandlerPackage_70_Ver360::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
...
void HandlerPackage_70_Ver360::deleteView()
{
