...
HandlerPackage_254_Ver360::HandlerPackage_254_Ver360(QObject *parent)
...
bool HandlerPackage_254_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 254 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_254_Ver360::saveData );

        m_lenPkgVar = new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(23, 23);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_254_Ver360::saveData );
...
void HandlerPackage_254_Ver360::loadPkg()
{
...
void HandlerPackage_254_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_254_Ver360::saveData()
{
...
void HandlerPackage_254_Ver360::deleteView()
{
