...
HandlerPackage_72_Ver360::HandlerPackage_72_Ver360(QObject *parent)
...
bool HandlerPackage_72_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 72 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );

        m_lenPkgVar = new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(100);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );

        m_qTextclassVar = new package::GraphicVariablePkg ;
        m_qTextclassVar->set_Q_TEXTCLASS();
        m_VariableVect.push_back(m_qTextclassVar);
        connect (m_qTextclassVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        ...
        connect (m_qTextdisplayVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        ...
        connect (m_dTextdisplayVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        ...
        connect (m_mModeltextdisplay_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        ...
        connect (m_mLeveltextdisplay_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        connect (m_mLeveltextdisplay_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::show_nidNtc_1_SL );

        {
            ...
            connect (m_nidNtc_1_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        }
        ...
        connect (m_lTextdisplayVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        ...
        connect (m_tTextdisplayVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        ...
        connect (m_mModeltextdisplay_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        ...
        connect (m_mLeveltextdisplay_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        connect (m_mLeveltextdisplay_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::show_nidNtc_2_SL );

        {
            ...
            connect (m_nidNtc_2_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        }
        ...
        connect (m_qTextconfirmVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        connect (m_qTextconfirmVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::show_qTextConfirm_SL );

        {
            ...
            connect (m_qConftextdisplayVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
            ...
            connect (m_qTextreportVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
            ...
            connect (m_nidTextmessageVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );

            m_nidCVar = new package::GraphicVariablePkg ;
            m_nidCVar->set_NID_C();
            m_nidCVar->setTobeVisible(false);
            m_VariableVect.push_back(m_nidCVar);
            connect (m_nidCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
            ...
            connect (m_nidRBCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        }

        m_lTextVar = new package::GraphicVariablePkg ;
        m_lTextVar->set_L_TEXT();
        m_VariableVect.push_back(m_lTextVar);
        connect (m_lTextVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );

        m_xTextVar = new package::GraphicVariablePkg ;
        m_xTextVar->set_X_TEXT();
        m_VariableVect.push_back(m_xTextVar);
        connect (m_xTextVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::saveData );
        connect (m_xTextVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_72_Ver360::update_text_SL );
...
void HandlerPackage_72_Ver360::show_nidNtc_1_SL()
{
...
void HandlerPackage_72_Ver360::show_nidNtc_2_SL()
{
...
void HandlerPackage_72_Ver360::show_qTextConfirm_SL()
{
...
/* Update value of packet len and variable L_TEXT */
void HandlerPackage_72_Ver360::update_text_SL()
{
    /* GET size of text */
    QString text = m_xTextVar->valueOfVariable();
    int textSize = text.size();

    m_xTextVar->setVariableBitSize(textSize * 8);
    m_lTextVar->setDefaultValue(textSize);

    this->showVariable();
}

void HandlerPackage_72_Ver360::loadPkg()
{
...
void HandlerPackage_72_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_72_Ver360::saveData()
{
...
void HandlerPackage_72_Ver360::deleteView()
{
