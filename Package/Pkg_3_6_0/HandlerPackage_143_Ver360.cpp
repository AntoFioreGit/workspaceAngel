...
HandlerPackage_143_Ver360::HandlerPackage_143_Ver360(QObject *parent)
...
bool HandlerPackage_143_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 143 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_143_Ver360::saveData );

        m_lenPkgVar = new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(24, 32);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_143_Ver360::saveData );

        m_qRiuVar = new package::GraphicVariablePkg;
        m_qRiuVar->set_Q_RIU();
        m_VariableVect.push_back(m_qRiuVar);
        connect (m_qRiuVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_143_Ver360::saveData );

        m_nidCVar = new package::GraphicVariablePkg;
        m_nidCVar->set_NID_C();
        m_VariableVect.push_back(m_nidCVar);
        connect (m_nidCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_143_Ver360::saveData );

        m_nidRiuVar = new package::GraphicVariablePkg;
        m_nidRiuVar->set_NID_RIU();
        m_VariableVect.push_back(m_nidRiuVar);
        connect (m_nidRiuVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_143_Ver360::saveData );

        m_nidRadioVar = new package::GraphicVariablePkg;
        m_nidRadioVar->set_NID_RADIO();
        m_VariableVect.push_back(m_nidRadioVar);
        connect (m_nidRadioVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_143_Ver360::saveData );
...
void HandlerPackage_143_Ver360::loadPkg()
{
...
void HandlerPackage_143_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_143_Ver360::saveData()
{
...
void HandlerPackage_143_Ver360::deleteView()
{
