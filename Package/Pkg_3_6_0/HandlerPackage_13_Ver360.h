#ifndef HANDLERPACKAGE_13_VER360_H
#define HANDLERPACKAGE_13_VER360_H
...
namespace package {
class HandlerPackage_13_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_13_Ver360(QObject *parent = nullptr);
