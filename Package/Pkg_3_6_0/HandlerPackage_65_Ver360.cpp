...
HandlerPackage_65_Ver360::HandlerPackage_65_Ver360(QObject *parent)
...
bool HandlerPackage_65_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 65 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_65_Ver360::saveData );
        ...
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_65_Ver360::saveData );

        m_nidTSRVar = new package::GraphicVariablePkg;
        m_nidTSRVar->set_NID_TSR();
        m_VariableVect.push_back(m_nidTSRVar);
        connect (m_nidTSRVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_65_Ver360::saveData );

        m_dTSRVar = new package::GraphicVariablePkg;
        m_dTSRVar->set_D_TSR();
        m_VariableVect.push_back(m_dTSRVar);
        connect (m_dTSRVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_65_Ver360::saveData );

        m_lTSRVar = new package::GraphicVariablePkg;
        m_lTSRVar->set_L_TSR();
        m_VariableVect.push_back(m_lTSRVar);
        connect (m_lTSRVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_65_Ver360::saveData );

        m_qFrontVar = new package::GraphicVariablePkg;
        m_qFrontVar->set_Q_FRONT();
        m_VariableVect.push_back(m_qFrontVar);
        connect (m_qFrontVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_65_Ver360::saveData );

        m_vTSRVar = new package::GraphicVariablePkg;
        m_vTSRVar->set_Q_FRONT();
        m_VariableVect.push_back(m_vTSRVar);
        connect (m_vTSRVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_65_Ver360::saveData );
...
void HandlerPackage_65_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_65_Ver360::saveData()
{
    QString data;
...
void HandlerPackage_65_Ver360::deleteView()
{
...
void HandlerPackage_65_Ver360::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
