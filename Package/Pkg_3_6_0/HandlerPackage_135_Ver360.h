#ifndef HANDLERPACKAGE_135_VER360_H
#define HANDLERPACKAGE_135_VER360_H
...
namespace package {
class HandlerPackage_135_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_135_Ver360(QObject *parent = nullptr);
