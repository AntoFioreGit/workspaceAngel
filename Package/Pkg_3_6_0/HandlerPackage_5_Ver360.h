#ifndef HANDLERPACKAGE_5_VER360_H
#define HANDLERPACKAGE_5_VER360_H
...
namespace package {
class HandlerPackage_5_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_5_Ver360(QObject *parent = nullptr);
...
#endif // HANDLERPACKAGE_5_VER360_H
