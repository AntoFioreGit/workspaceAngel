#ifndef HANDLERPACKAGE_136_VER360_H
#define HANDLERPACKAGE_136_VER360_H
...
namespace package {
class HandlerPackage_136_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_136_Ver360(QObject *parent = nullptr);
