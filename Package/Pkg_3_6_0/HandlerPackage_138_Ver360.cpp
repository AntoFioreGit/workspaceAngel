...
HandlerPackage_138_Ver360::HandlerPackage_138_Ver360(QObject *parent)
    : HandlerPackage{parent}
{
    ...
    m_dStartreverseVar = nullptr;
    m_lReverseareaVar = nullptr;
...
bool HandlerPackage_138_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 138 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_138_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(55,55);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_138_Ver360::saveData );

        m_dStartreverseVar =  new package::GraphicVariablePkg ;
        m_dStartreverseVar->set_D_STARTREVERSE();
        m_VariableVect.push_back(m_dStartreverseVar);
        connect (m_dStartreverseVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_138_Ver360::saveData );

        m_lReverseareaVar =  new package::GraphicVariablePkg ;
        m_lReverseareaVar->set_L_REVERSEAREA();
        m_VariableVect.push_back(m_lReverseareaVar);
        connect (m_lReverseareaVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_138_Ver360::saveData );
...
void HandlerPackage_138_Ver360::loadPkg()
{
...
void HandlerPackage_138_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_138_Ver360::saveData()
{
...
void HandlerPackage_138_Ver360::deleteView()
{
