#ifndef HANDLERPACKAGE_145_VER360_H
#define HANDLERPACKAGE_145_VER360_H
...
namespace package {
class HandlerPackage_145_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_145_Ver360(QObject *parent = nullptr);
