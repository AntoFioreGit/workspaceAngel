...
HandlerPackage_68_Ver360::HandlerPackage_68_Ver360(QObject *parent)
...
bool HandlerPackage_68_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 68 - " + QString(BASELINE_3_6_0));
        ...
        showVariable();
        ret=saveData();
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        connect (m_ScaleVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_68_Ver360::handleChangeScaleVariable_SL );
        connect (m_ScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        connect (m_qTrackInitVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_68_Ver360::handleChangeQ_TrackInitVariable_SL );
        connect (m_qTrackInitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        connect (m_dTrackInitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        connect (m_dTrackCondVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        connect (m_lTrackCondVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        connect (m_mTrackCondVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
        ...
        for (int i = positionIterateVar ;i < size ;i++) {
            ...
            if (nullptr != variable){
                connect (variable,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_68_Ver360::saveData );
            }
...
void HandlerPackage_68_Ver360::loadPkg()
{
...
void HandlerPackage_68_Ver360::handleChangeIteration_SL()
{
...
void HandlerPackage_68_Ver360::handleChangeScaleVariable_SL(QString nameVariable)
{
...
void HandlerPackage_68_Ver360::handleChangeQ_TrackInitVariable_SL(QString nameVariable)
{
    package::GraphicVariablePkg * variable= qobject_cast<package::GraphicVariablePkg *>(variableByName(nameVariable));
    if (nullptr != variable){
...
void HandlerPackage_68_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_68_Ver360::saveData()
{
...
void HandlerPackage_68_Ver360::deleteView()
{
