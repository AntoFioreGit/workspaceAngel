...
HandlerPackage_64_Ver360::HandlerPackage_64_Ver360(QObject *parent)
...
bool HandlerPackage_64_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 64 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_64_Ver360::saveData );
...
void HandlerPackage_64_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_64_Ver360::saveData()
{
    QString data;
...
void HandlerPackage_64_Ver360::deleteView()
{
...
void HandlerPackage_64_Ver360::loadPkg()
{
    storageData::StorageOutDataBaliseCommand &outBalsCmd=storageData::MngStorageOutCommand::istance()->storageBaliseCmd();
