...
HandlerPackage_63_Ver360::HandlerPackage_63_Ver360(QObject *parent)
...
bool HandlerPackage_63_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 63 - " + QString(BASELINE_3_6_0));
        ...
        for (int i = 0;i < maxValueVariableIter ;i++) {
            ...
            //   connect (qNewCountry,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_63_Ver360::handleIterateVariable_SL );
            //   connect (qNewCountry,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_63_Ver360::saveData );
        ...
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_63_Ver360::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_63_Ver360::saveData );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_63_Ver360::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_63_Ver360::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_63_Ver360::saveData );
        ...
        for (int i = positionIterateVar ;i < size ;i++) {
            ...
            if (nullptr != variable){
                if (2==idxConnectIterate){
                    connect (variable,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_63_Ver360::handleIterateVariable_SL );

                }
                connect (variable,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_63_Ver360::saveData );
                idxConnectIterate--;
...
void HandlerPackage_63_Ver360::loadPkg()
{
...
void HandlerPackage_63_Ver360::handleChangeIteration_SL()
{
...
void HandlerPackage_63_Ver360::handleIterateVariable_SL(QString nameVariable)
{
...
void HandlerPackage_63_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_63_Ver360::saveData()
{
...
void HandlerPackage_63_Ver360::deleteView()
{
