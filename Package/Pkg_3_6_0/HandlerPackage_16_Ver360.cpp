...
HandlerPackage_16_Ver360::HandlerPackage_16_Ver360(QObject *parent)
...
bool HandlerPackage_16_Ver360::creteView()
{
    m_currCol=0;
    m_row =0;
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 16 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(40,40);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver360::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver360::saveData );
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver360::setRangeCurrent_SL );

        m_lSectionVar = new package::GraphicVariablePkg ;
        m_lSectionVar->set_L_SECTION();
        m_VariableVect.push_back(m_lSectionVar);
        connect (m_lSectionVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_16_Ver360::saveData );
...
void HandlerPackage_16_Ver360::loadPkg()
{
...
void HandlerPackage_16_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    ...
    m_spaced = new QSpacerItem (40,16,QSizePolicy::Expanding,QSizePolicy::Expanding) ;
    m_layOutPkg->addItem(m_spaced, m_row+1,m_maxColumnVariable+1);

}


bool HandlerPackage_16_Ver360::saveData()
{
...
void HandlerPackage_16_Ver360::deleteView()
{
    HandlerPackage::deleteView();
}

void HandlerPackage_16_Ver360::setRangeCurrent_SL()
{
    switch (m_qScaleVar->valueOfVariable().toInt()) {
    case 0:
    case 2:
        m_lSectionVar->setRange(0,327670);
        break;
    case 1:
        m_lSectionVar->setRange(0,32767);
        break;
    default:
        break;
    }
