...
HandlerPackage_45_Ver360::HandlerPackage_45_Ver360(QObject *parent)
...
bool HandlerPackage_45_Ver360::creteView()
{

    qDebug () << "HandlerPackage_45_Ver360::creteView();";
    bool ret = false;
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 45 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_45_Ver360::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_45_Ver360::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_45_Ver360::saveData );
        connect (m_Nid_MnVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_45_Ver360::saveData );
...
bool HandlerPackage_45_Ver360::saveData()
{
...
void HandlerPackage_45_Ver360::deleteView()
{
...
void HandlerPackage_45_Ver360::loadPkg()
{
...
void HandlerPackage_45_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
