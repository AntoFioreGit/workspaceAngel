...
HandlerPackage_67_Ver360::HandlerPackage_67_Ver360(QObject *parent)
...
bool HandlerPackage_67_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 67 - " + QString(BASELINE_3_6_0));
        ...
        showVariable();
        ret=saveData();
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_67_Ver360::saveData );
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_67_Ver360::saveData );
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_67_Ver360::saveData );
        connect (m_ScaleVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_67_Ver360::handleIterateVariable_SL );
        connect (m_ScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_67_Ver360::saveData );
        connect (m_dTrackCond,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_67_Ver360::saveData );
        connect (m_lTrackCond,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_67_Ver360::saveData );

        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_67_Ver360::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_67_Ver360::saveData );
        ...
        for (int i = positionIterateVar ;i < size ;i++) {
            ...
            if (nullptr != variable){
                connect (variable,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_67_Ver360::saveData );
            }
        }
    }
    return ret;
...
void HandlerPackage_67_Ver360::loadPkg()
{
...
void HandlerPackage_67_Ver360::handleChangeIteration_SL()
{
...
void HandlerPackage_67_Ver360::handleIterateVariable_SL(QString nameVariable)
{
...
void HandlerPackage_67_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_67_Ver360::saveData()
{
...
void HandlerPackage_67_Ver360::deleteView()
{
