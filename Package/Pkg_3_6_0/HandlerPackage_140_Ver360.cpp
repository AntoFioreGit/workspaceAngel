...
HandlerPackage_140_Ver360::HandlerPackage_140_Ver360(QObject *parent)
...
bool HandlerPackage_140_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 140 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_140_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(55,55);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_140_Ver360::saveData );

        m_nidOperationalVar =  new package::GraphicVariablePkg ;
        m_nidOperationalVar->set_NID_OPERATIONAL();
        m_VariableVect.push_back(m_nidOperationalVar);
        connect (m_nidOperationalVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_140_Ver360::saveData );
...
void HandlerPackage_140_Ver360::loadPkg()
{
...
void HandlerPackage_140_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_140_Ver360::saveData()
{
...
void HandlerPackage_140_Ver360::deleteView()
{
