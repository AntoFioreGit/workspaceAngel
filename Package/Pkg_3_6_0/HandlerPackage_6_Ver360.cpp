...
HandlerPackage_6_Ver360::HandlerPackage_6_Ver360(QObject *parent)
...
bool HandlerPackage_6_Ver360::creteView()
{

    qDebug () << "HandlerPackage_6_Ver360::creteView();";
    bool ret = false;

    if (nullptr != m_layOutPkg){

        m_titlePkg = new package::GraphicTitlePkg;
        m_titlePkg->init("Packet 6 - " + QString(BASELINE_3_6_0));
        ...
        row++;
         ...
         if (m_isReload) {
          ...
          showVariable();
          ret=saveData();
         connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_6_Ver360::saveData );
         connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_6_Ver360::saveData );
         connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_6_Ver360::saveData );
         connect ( m_nidqVBCOVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_6_Ver360::saveData );
         connect ( m_nidqVBCOVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_6_Ver360::showTVBC );
         connect ( m_nidVBCMKVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_6_Ver360::saveData );
         connect (  m_nidCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_6_Ver360::saveData );
         connect ( m_TVBCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_6_Ver360::saveData );
...
void HandlerPackage_6_Ver360::showTVBC()
{
...
void HandlerPackage_6_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_6_Ver360::saveData()
{
...
void HandlerPackage_6_Ver360::deleteView()
{
...
void HandlerPackage_6_Ver360::loadPkg()
{
