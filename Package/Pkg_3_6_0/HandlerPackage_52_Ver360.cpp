...
HandlerPackage_52_Ver360::HandlerPackage_52_Ver360(QObject *parent)
...
bool HandlerPackage_52_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 52 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(41);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );

        m_qScaleVar = new package::GraphicVariablePkg ;
        m_qScaleVar->set_Q_SCALE();
        m_VariableVect.push_back(m_qScaleVar);
        connect (m_qScaleVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );

        m_qTrackinitVar = new package::GraphicVariablePkg;
        m_qTrackinitVar->set_Q_TRACKINIT();
        m_VariableVect.push_back(m_qTrackinitVar);
        connect (m_qTrackinitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::show_qTrackinit_SL );
        connect (m_qTrackinitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );

        {
            ...
            connect (m_dTrackinitVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
            ...
            connect (m_dPBDVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
            ...
            connect (m_qGdirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
            ...
            connect (m_gPBDSRVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
            ...
            connect (m_qPBDSRVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
            ...
            connect (m_dPBDSRVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
            ...
            connect (m_lPBDSRVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
            ...
            connect (m_nIter_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::handleChangeIteration_k_SL );
            connect (m_nIter_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
            ...
            for (int n = 0; n < maxValueVariableIter_n ; n++)
            {
                ...
                connect (m_dPBD_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
                ...
                connect (m_qGdir_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
                ...
                connect (m_gPBDSR_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
                ...
                connect (m_qPBDSR_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
                ...
                connect (m_dPBDSR_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
                ...
                connect (m_lPBDSR_k_Var,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_52_Ver360::saveData );
            }
        }
...
void HandlerPackage_52_Ver360::loadPkg()
{
...
void HandlerPackage_52_Ver360::show_qTrackinit_SL()
{
...
void HandlerPackage_52_Ver360::handleChangeIteration_k_SL()
{
...
void HandlerPackage_52_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_52_Ver360::saveData()
{
...
void HandlerPackage_52_Ver360::deleteView()
{
