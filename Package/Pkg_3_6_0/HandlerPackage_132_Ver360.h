#ifndef HANDLERPACKAGE_132_VER360_H
#define HANDLERPACKAGE_132_VER360_H
...
namespace package {
class HandlerPackage_132_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_132_Ver360(QObject *parent = nullptr);
