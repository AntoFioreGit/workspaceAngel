#ifndef HANDLERPACKAGE_90_VER360_H
#define HANDLERPACKAGE_90_VER360_H
...
namespace package {
class HandlerPackage_90_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_90_Ver360(QObject *parent = nullptr);
