#ifndef HANDLERPACKAGE_40_VER360_H
#define HANDLERPACKAGE_40_VER360_H
...
namespace package {
class HandlerPackage_40_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_40_Ver360(QObject *parent = nullptr);
