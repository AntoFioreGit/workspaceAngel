...
HandlerPackage_90_Ver360::HandlerPackage_90_Ver360(QObject *parent)
...
bool HandlerPackage_90_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 90 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_90_Ver360::saveData );

        m_lenPkgVar =  new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(38,48);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_90_Ver360::saveData );
        ...
        connect (m_qNewcountryVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_90_Ver360::saveData );
        connect (m_qNewcountryVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_90_Ver360::show_NIDc_SL );
        ...
        connect (m_nidCVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_90_Ver360::saveData );

        m_nidBgVar =  new package::GraphicVariablePkg ;
        m_nidBgVar->set_NID_BG();
        m_VariableVect.push_back(m_nidBgVar);
        connect (m_nidBgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_90_Ver360::saveData );
...
void HandlerPackage_90_Ver360::show_NIDc_SL()
{
...
void HandlerPackage_90_Ver360::loadPkg()
{
...
void HandlerPackage_90_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_90_Ver360::saveData()
{
...
void HandlerPackage_90_Ver360::deleteView()
{
