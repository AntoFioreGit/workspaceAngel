...
HandlerPackage_57_Ver360::HandlerPackage_57_Ver360(QObject *parent)
...
bool HandlerPackage_57_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_57_Ver360::saveData );

        m_lenPkgVar = new package::GraphicVariablePkg ;
        m_lenPkgVar->set_L_PACKET(49, 49);
        m_VariableVect.push_back(m_lenPkgVar);
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_57_Ver360::saveData );
        ...
        connect (m_tMarVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_57_Ver360::saveData );
        ...
        connect (m_tTimeoutrqstVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_57_Ver360::saveData );
        ...
        connect (m_tCycrqstVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_57_Ver360::saveData );
...
void HandlerPackage_57_Ver360::loadPkg()
{
...
void HandlerPackage_57_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
...
bool HandlerPackage_57_Ver360::saveData()
{
...
void HandlerPackage_57_Ver360::deleteView()
{
