#ifndef HANDLERPACKAGE_254_VER360_H
#define HANDLERPACKAGE_254_VER360_H
...
namespace package {
class HandlerPackage_254_Ver360 : public HandlerPackage
{
    Q_OBJECT
public:
    explicit HandlerPackage_254_Ver360(QObject *parent = nullptr);
