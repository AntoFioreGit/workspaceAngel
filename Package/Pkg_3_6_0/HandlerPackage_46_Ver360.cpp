...
HandlerPackage_46_Ver360::HandlerPackage_46_Ver360(QObject *parent)
...
bool HandlerPackage_46_Ver360::creteView()
{
    ...
    if (nullptr != m_layOutPkg){
        ...
        m_titlePkg->init("Packet 46 - " + QString(BASELINE_3_6_0));
        ...
        connect (m_nidPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::saveData );
        ...
        connect (m_qDirVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::saveData );
        ...
        connect (m_lenPkgVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::saveData );
        ...
        connect (m_mLevelTrVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::showNid_Ntc_SL );
        connect (m_mLevelTrVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::saveData );
        ...
        connect (m_NidNtcVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::saveData );
        ...
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::handleChangeIteration_SL );
        connect (m_nIterVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::saveData );
        ...
        for (int i = 0;i < maxValueVariableIter ;i++) {
            ...
            connect (levelTrVar,&GraphicVariablePkg::nameInernalVariable_SG,this,&HandlerPackage_46_Ver360::handleIterateVariable_SL );
            connect (levelTrVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::saveData );
            ...
            connect (nidNtcVar,&GraphicVariablePkg::updateData_SG,this,&HandlerPackage_46_Ver360::saveData );
...
void HandlerPackage_46_Ver360::loadPkg()
{
...
void HandlerPackage_46_Ver360::showNid_Ntc_SL()
{
...
void HandlerPackage_46_Ver360::handleChangeIteration_SL()
{
...
void HandlerPackage_46_Ver360::handleIterateVariable_SL(QString nameVariable)
{
...
void HandlerPackage_46_Ver360::showVariable()
{
    m_row=1;
    m_currCol=0;
    removeSpacer();
...
bool HandlerPackage_46_Ver360::saveData()
{
...
void HandlerPackage_46_Ver360::deleteView()
{
