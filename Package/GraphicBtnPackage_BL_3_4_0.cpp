...
#include "Define.h"
namespace pkg{
GraphicBtnPackage_BL_3_4_0::GraphicBtnPackage_BL_3_4_0(QObject *parent)
    : GraphicBtnPackage{parent}
{

}

void GraphicBtnPackage_BL_3_4_0::init(QWidget *parent)
{
    m_baseLine = baseline_340;
    ...
    propGraphic.m_backGroiund=defaultBackColorBL_3_4_0;
    propGraphic.m_color=defaultColorBL_3_4_0;
...
void GraphicBtnPackage_BL_3_4_0::addAction(QString text, int actBtnId)
{
    if (m_first){
        m_first = false;
        QLabel *bl_label = new QLabel ("BL 2",m_parent);
    ...
    grProp.m_color=defaultColorBL_3_4_0;
    grProp.m_backGroiund=defaultBackColorBL_3_4_0;

    m_graphicPropetiesMap.insert(actBtnId,grProp);

}
void GraphicBtnPackage_BL_3_4_0::handleActionToggled_SL(int idAction, bool checked)
{
    Q_UNUSED(idAction)
    Q_UNUSED(checked)
...
void GraphicBtnPackage_BL_3_4_0::handleActionPush_SL(int idAction)
{
