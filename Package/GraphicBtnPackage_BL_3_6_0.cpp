...
#include "Define.h"
namespace pkg{
GraphicBtnPackage_BL_3_6_0::GraphicBtnPackage_BL_3_6_0(QObject *parent)
    : GraphicBtnPackage{parent}
{

}

void GraphicBtnPackage_BL_3_6_0::init(QWidget *parent)
{

    GraphicBtnPackage::init(parent);
     m_glBtn->setContentsMargins(1,1,1,1);
     m_glBtn->setVerticalSpacing(2);

    m_baseLine = baseline_360;

    m_package.push_back(0);
    ...
    m_package.push_back(143);
    m_package.push_back(145);

    m_package.push_back(180);
    m_package.push_back(181);
    ...
    propGraphic.m_backGroiund=defaultBackColorBL_3_6_0;
    propGraphic.m_color=defaultColorBL_3_6_0;
...
void GraphicBtnPackage_BL_3_6_0::addAction(QString text, int actBtnId)
{

    if (m_first){
        m_first = false;
        QLabel *bl_label = new QLabel ("BL 3",m_parent);
   ...
   // btn->setStyle(m_style);

    btn->setFont(font);
     _buttonMap.insert(actBtnId,btn);
     if (actBtnId == 67){

         QSpacerItem *  m_spaced = new QSpacerItem (40,0,QSizePolicy::Expanding,QSizePolicy::Fixed) ;
          m_glBtn->addItem(m_spaced, m_row,m_column);
         m_row++;
         m_column=1;
     }
     ...
     grProp.m_color=defaultColorBL_3_6_0;
     grProp.m_backGroiund=defaultBackColorBL_3_6_0;
...
void GraphicBtnPackage_BL_3_6_0::handleActionToggled_SL(int idAction, bool checked)
{
    Q_UNUSED(idAction)
    Q_UNUSED(checked)
...
void GraphicBtnPackage_BL_3_6_0::handleActionPush_SL(int idAction)
{
