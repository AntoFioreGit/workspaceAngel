#ifndef GRAPHICHANDLERCOMMAND_T_APDM_H
#define GRAPHICHANDLERCOMMAND_T_APDM_H
...
class GraphicHandlerCommand_T_APDM : public GraphicHandlerCommand
{
    Q_OBJECT
public:
    explicit GraphicHandlerCommand_T_APDM(QObject *parent = nullptr);
     bool initCommands();
     ...
     virtual void showCommand_SL (QString command, qint32 rowTable) override;
      ...
      virtual bool isCurrentTab() override;
...
#endif // GRAPHICHANDLERCOMMAND_T_APDM_H
}
